...
#include "SDL_event_xt894.h"
#include "SDL_gles_xt894.h"
#include "SDL_fb_xt894.h"

static int XT894_VideoInit(_THIS);
static int XT894_SetDisplayMode(_THIS, SDL_VideoDisplay *display, SDL_DisplayMode *mode);
...
void XT894_DestroyWindow(_THIS, SDL_Window *window)
{
    debug("%s\n", __func__);
}

int XT894_CreateWindow(_THIS, SDL_Window *window)
{
...
int XT894_CreateWindowFrom(_THIS, SDL_Window *window, const void *data)
{
    debug("%s\n", __func__);
...
static SDL_VideoDevice *XT894_CreateDevice(int devindex)
{
    ...
    device->SetDisplayMode = XT894_SetDisplayMode;
    device->PumpEvents = XT894_PumpEvents;
    device->CreateSDLWindow = XT894_CreateWindow;
    device->CreateSDLWindowFrom = XT894_CreateWindowFrom;
    device->CreateWindowFramebuffer = XT894_CreateWindowFramebuffer;
    device->UpdateWindowFramebuffer = XT894_UpdateWindowFramebuffer;
    device->DestroyWindowFramebuffer = XT894_DestroyWindowFramebuffer;
    device->DestroyWindow = XT894_DestroyWindow;
...
VideoBootStrap XT894_bootstrap = {XT894_DRIVER_NAME, "XT894 VIDEO DRIVER", XT894_CreateDevice};
