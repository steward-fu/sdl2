...
#ifndef __SDL_EVENT_A30_H__
#define __SDL_EVENT_A30_H__
...
#define A30_KEYPAD_MODE 0
#define A30_MOUSE_MODE  1

typedef struct _A30_EventInfo {
    struct _keypad{
        uint32_t bitmaps;
    } keypad;
...
extern void A30_EventInit(void);
extern void A30_EventDeinit(void);
extern void A30_PumpEvents(_THIS);
